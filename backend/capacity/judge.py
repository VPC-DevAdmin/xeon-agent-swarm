...
STAGE_GROUPS = {
    ...
    "sandbox_wall": tuple(f"sandbox_{k}_wall_ms" for k in ("light", "heavy", "large", "large_rerun", "xl", "build",
                                                            "setup", "ci", "verify", "ingest", "scan", "fetch")),
    "sandbox_cpu": tuple(f"sandbox_{k}_cpu_ms" for k in ("light", "heavy", "large", "large_rerun", "xl", "build",
                                                           "setup", "ci", "verify", "ingest", "scan", "fetch")),
