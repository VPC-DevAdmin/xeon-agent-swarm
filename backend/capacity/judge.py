...
STAGE_GROUPS = {
    ...
    "sandbox_wall": ("sandbox_light_wall_ms", "sandbox_heavy_wall_ms", "sandbox_large_wall_ms", "sandbox_xl_wall_ms",
                     "sandbox_build_wall_ms", "sandbox_ingest_wall_ms"),
    "sandbox_cpu": ("sandbox_light_cpu_ms", "sandbox_heavy_cpu_ms", "sandbox_large_cpu_ms", "sandbox_xl_cpu_ms",
